...
export const usePromoCode = catchAsync(async (req: Request, res: Response) => {
  ...
  const text = `Congratulations, ${user.firstName}! You have successfully redeemed the coupon code "${cuponCode}". The coupon is valid for ${numericDuration} month(s) and will expire on ${formattedExpiryDate}. Enjoy the benefits!`;
